    ...
    <div class="blog-area ptb-100">
        <div class="container">
            ...
            <div class="section-title">
                <span class="sub-title">Peserta</span>
                <h2>PTSP Provinsi</h2>
            </div>
            <div class="row justify-content-center mb-5">
                <div
                    ...
                    :key="item.id"
                    class="col-lg-4 col-md-6 profile-card"
                >
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area d-flex align-items-center">
                        <button
                            :disabled="provPage == 1"
                            @click="() => prevPage('provinsi')"
                            class="prev page-numbers"
                        >
                            <i class="ri-arrow-left-line"></i>
                        </button>
                        <button
                            v-for="page in provRenderPage"
                            :key="page"
                            :disabled="page == '...'"
                            @click="goToPage(page, 'provinsi')"
                            class="btn nav-links"
                        >
                            <span
                                :class="[
                                    page === provPage ? 'current' : '',
                                    'page-numbers',
                                ]"
                                >{{ page }}</span
                            >
                        ...
                        <button
                            :disabled="provPage >= provTotalPage"
                            @click="() => nextPage('provinsi')"
            ...
            <div class="section-title">
                <span class="sub-title">Peserta</span>
                <h2>PTSP Kabupaten</h2>
            </div>
            <div class="row justify-content-center mb-5">
                <div
                    v-for="item in kabData"
                    :key="item.id"
                    class="col-lg-4 col-md-6 profile-card"
                >
                    <div class="single-blog-post">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area d-flex align-items-center">
                        <button
                            :disabled="kabPage == 1"
                            @click="() => prevPage('kabupaten')"
                            class="prev page-numbers"
                        >
                            <i class="ri-arrow-left-line"></i>
                        </button>
                        <button
                            v-for="page in kabRenderPage"
                            :key="page"
                            :disabled="page == '...'"
                            @click="goToPage(page, 'kabupaten')"
                            class="btn nav-links"
                        >
                            <span
                                :class="[
                                    page === kabPage ? 'current' : '',
                                    'page-numbers',
                                ]"
                                >{{ page }}</span
                            >
                        ...
                        <button
                            :disabled="kabPage >= kabTotalPage"
                            @click="() => nextPage('kabupaten')"
                            class="next page-numbers"
                        >
                            <i class="ri-arrow-right-line"></i>
                        </button>
            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area d-flex align-items-center">
                        ...
                        <button
                            v-for="page in kotRenderPage"
                            :key="page"
                            :disabled="page == '...'"
                            @click="goToPage(page, 'kota')"
                            class="btn nav-links"
                        >
                            <span
                                :class="[
                                    page === kotaPage ? 'current' : '',
                                    'page-numbers',
                                ]"
                                >{{ page }}</span
                            >
                        ...
                        <button
                            :disabled="kotaPage >= kotTotalPage"
                            @click="() => nextPage('kota')"
                            class="next page-numbers"
                        >
                            <i class="ri-arrow-right-line"></i>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area d-flex align-items-center">
                        ...
                        <button
                            v-for="page in klRenderPage"
                            :key="page"
                            :disabled="page == '...'"
                            @click="goToPage(page, 'kl')"
                            class="btn nav-links"
                        >
                            <span
                                :class="[
...
export default {
    ...
    computed: {
        ...
        provData() {
            const start =
                this.pageSize * this.provPage - (this.pageSize - 1) - 1;
        ...
        kabData() {
            const start =
                this.pageSize * this.kabPage - (this.pageSize - 1) - 1;
        ...
        kotData() {
            const start =
                this.pageSize * this.kotaPage - (this.pageSize - 1) - 1;
        ...
        provRenderPage() {
            let pages = [];
            let maxPages = 0;
            const pageLaps = Math.floor(
                (this.maxPage + this.provPage) / this.maxPage
            );

            for (
                let i =
                    this.provPage < this.maxPage
                        ? 1
                        : this.maxPage * pageLaps - this.maxPage;
                i <= this.maxPage * pageLaps;
                i++
            ) {
                maxPages = i;
                pages.push(i);
        ...
        kabRenderPage() {
            ...
            let maxPages = 0;
            const pageLaps = Math.floor(
                (this.maxPage + this.kabPage) / this.maxPage
            );

            for (
                let i =
                    this.kabPage < this.maxPage
                        ? 1
                        : this.maxPage * pageLaps - this.maxPage;
                i <= this.maxPage * pageLaps;
                i++
        ...
        kotRenderPage() {
            ...
            let maxPages = 0;
            const pageLaps = Math.floor(
                (this.maxPage + this.kotaPage) / this.maxPage
            );

            for (
                let i =
                    this.kotaPage < this.maxPage
                        ? 1
                        : this.maxPage * pageLaps - this.maxPage;
                i <= this.maxPage * pageLaps;
                i++
        ...
        klRenderPage() {
            ...
            let maxPages = 0;
            const pageLaps = Math.floor(
                (this.maxPage + this.klPage) / this.maxPage
            );

            for (
                let i =
                    this.klPage < this.maxPage
                        ? 1
                        : this.maxPage * pageLaps - this.maxPage;
                i <= this.maxPage * pageLaps;
                i++

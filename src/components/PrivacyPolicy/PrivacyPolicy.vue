    ...
    <div class="privacy-policy-area ptb-100">
        <div class="container">
            <div class="privacy-policy-content">
                ...
                <p>This site is provided by <stronzg>Jexa</stronzg>. <strong>Jexa</strong> collects information in several ways from different parts of this site.</p>
                ...
                <p><strong>Jexa</strong> accepts the following payment methods:</p>
                <ul>
                    ...
                    <li><strong>Jexa</strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>

<template>
    ...
    <div class="features-area ptb-100 bg-white">
            <div class="container">
                <div class="section-title">
                    <h2>Video Tutorial Penggunaan Sistem TIK Penilaian Kinerja</h2>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="iframe-panduan" style="flex-direction: column; display: flex;">
                            <iframe className="img-responsive" src="https://www.youtube.com/embed/bS7_QsKGSmw" />
                            <h6>PTSP Provinsi</h6>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="iframe-panduan">
                            <iframe className="img-responsive" src="https://www.youtube.com/embed/E7pYxOWK4aI" />
                            <h6>PTSP Kabupaten/Kota</h6>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="iframe-panduan">
    ...
    <div class="pricing-area ptb-100 bg-black" style="opacity: 80%">
            <div class="container">
                <div class="section-title">
                    <h2 style="color: whitesmoke">Panduan Penggunaan Sistem TIK Penilaian Kinerja</h2>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                            <i class="ri-book-open-line" style="color: black; font-size: 2em"></i>
                            <a
                                href="https://penkin-backend.denican.id/public/dokumen/Buku%20Panduan%20PTSP%20Pemda%20(Web).pdf"
                            >
                                <h6  style="color: black; padding-left: 1rem; padding-top: 0.7rem;" class="single-gallery-item">
                                    PTSP Pemda
                                </h6>
                            </a>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                            ...
                            >
                                <h6  style="color: black; padding-left: 1rem;" class="single-gallery-item">
                                    Peniliaian Pemangku Kepentiangan Organisasi Penguasa
                                </h6>
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                            ...
                            >
                                <h6  style="color: black; padding-left: 1rem;" class="single-gallery-item">
                                    Peniliaian Pemangku Kepentiangan Organisasi Penguasa (Mobile)
                                </h6>
                            </a>
                        </div>
                    </div>
    ...
    <div class="features-area ptb-100 bg-white">
            <div class="container">
                <div class="section-title">
                    <h2>Panduan Instrumen Peniliaian</h2>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                            ...
                            >
                                <h6  style="color: black; padding-left: 1rem;" class="single-gallery-item">
                                    Paparan Workshop Penilian Kinerja K/L
                                </h6>
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-sm-6 col-md-6">
                        <div class="pdf-panduan">
                            ...
                            >
                                <h6  style="color: black; padding-left: 1rem;" class="single-gallery-item">
                                    Penjelasan Instrumen Kinerja PPB Pemda
                                </h6>
                            </a>
                        </div>
                    </div>
